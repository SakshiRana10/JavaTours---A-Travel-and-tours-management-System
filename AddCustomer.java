...
AddCustomer(String username){
    ...
    add(l11);
       ...
       String ID[] = {"Passport", "Aadhar card", "Pan card", "Ration card"};
       c1 = new JComboBox(ID);
       c1.setBackground(Color.WHITE);
       c1.setBounds(240, 70, 200, 25);
       add(c1);
       ...
       add(l5);
        ...
        r1.setFont(new Font("SAN_SERIF", Font.BOLD, 13));
        r1.setForeground(Color.MAGENTA);
        r1.setBackground(Color.WHITE);
        r1.setBounds(240, 190, 75, 25);
        add(r1);

        r2 = new  JRadioButton("Female");
        r2.setFont(new Font("SAN_SERIF", Font.BOLD, 13));
        r2.setForeground(Color.BLUE);
        r2.setBackground(Color.WHITE);
        r2.setBounds(350, 190, 75, 25);
        add(r2);
       ...
       ImageIcon  i1 = new ImageIcon(ClassLoader.getSystemResource("javatours/icons/newcustomer.jpg"));
...
public void actionPerformed(ActionEvent ae){
    ...
    String id = (String)c1.getSelectedItem();                        //c1 will give an object which needs to be typecasted into a string                      
    ...
    String q = "insert into customerdet values('"+username+"','"+id+"','"+number+"','"+name+"','"+radio+"','"+country+"','"+address+"','"+phone+"','"+email+"' )";
    try{
        Conn c = new Conn();
        c.s.executeUpdate(q);
